...
*"Geospatial Framework for Assessing Suitability and Demand for Agricultural Digital Solutions in Europe"*. 
...
1. **Environmental, socio-economic, and connectivity variables**: These variables form the basis for the geospatial analysis conducted in the study.
1. **Derived indexes**: The indexes assess regional suitability and demand for agricultural digital solutions (ADS), as well as connectivity performance. These include:
   1. Natural Characteristics Similarity Index (NCSI)
   1. Socio-Economic Characteristics Similarity Index (SCSI)
   1. Fertilization Need Index (FNI)
   1. Irrigation Need Index (INI)
   1. Pest Management Need Index (PMNI)
   1. Rural Connectivity Performance Index (RCPI)

**Citation Guidelines**

Users of this dataset are required to cite the article *"Geospatial Framework for Assessing Suitability and Demand for Agricultural Digital Solutions in Europe"* 
...
10) **column\_name: Soil\_Organic\_Carbon (aggregated) (gr/kg)**

- **Data Type:** demical (double)
- **Description:** Aggregated value of soil organic carbon content within the NUTS3 region.
- **Units:** grams per kilogram (gr/kg)
- **Notes:** Derived from LUCAS 2018 Soil Module data and aggregated to NUTS3 polygons.

11) **column\_name: Nitrogen (aggregated) (gr/kg)**
- **Data Type:** demical (double)
- **Description:** Aggregated value of nitrogen content within the NUTS3 region.
- **Units:** grams per kilogram (gr/kg)
- **Notes:** Derived from soil repositories (e.g., LUCAS 2018 Soil Module) and aggregated to NUTS3 polygons.

12) **column\_name: Phosphorous (aggregated) (gr/kg)**
- **Data Type:** demical (double)
- **Description:** Aggregated value of phosphorous content within the NUTS3 region.
- **Units:** grams per kilogram (gr/kg)
- **Notes:** Derived from soil repositories (e.g., LUCAS 2018 Soil Module) and aggregated to NUTS3 polygons.** 

13) **column\_name: Soil\_Texture\_Sand (%)**
- **Data Type:** demical (double)
- **Description:** Aggregated percentage of sand content in the soil within the NUTS3 region.
- **Units:** Percentage (%)
- **Notes:** Derived from soil texture data (e.g., LUCAS 2018 Soil Module) and aggregated to NUTS3 polygons.** 

14) **column\_name: Soil\_Texture\_Clay (%)**
- **Data Type:** demical (double)
- **Description:** Aggregated percentage of clay content in the soil within the NUTS3 region.
- **Units:** Percentage (%)
- **Notes:** Derived from soil texture data (e.g., LUCAS 2018 Soil Module) and aggregated to NUTS3 polygons. 

15) **column\_name: Soil\_Texture\_Silt (%)**
- **Data Type:** demical (double)
- **Description:** Aggregated percentage of silt content in the soil within the NUTS3 region.
- **Units:** Percentage (%)
- **Notes:** Derived from soil texture data (e.g., LUCAS 2018 Soil Module) and aggregated to NUTS3 polygons.** 

The variables **Soil\_Organic\_Carbon, Nitrogen, Phosphorous, Soil\_Texture\_Sand, Soil\_Texture\_Clay, Soil\_Texture\_Silt** are derived from the LUCAS 2018 Soil Module, which provides comprehensive soil data for Europe. These variables were aggregated to the NUTS3 level polygons as part of the analysis.
...
16) **column\_name: Annual\_Precipitation**
- **Data Type:** demical (double)
...
17) **column\_name: Surface\_Soil\_Moisture (average for highest FAPAR) (volume fraction)**
- **Data Type:** demical (double)
...
18) **column\_name: Days\_year\_over\_10°C**
- **Data Type:** Integer
...
19) **column\_name: Species\_Richness**
...
20) **column\_name: Farms\_Predominant\_Size**
- **Data Type:** Text
...
21) **column\_name: Farms\_Predominant\_Economic\_Size**
- **Data Type:** Text
...
22) **column\_name: Farms\_Predominant\_Legal\_Form**
- **Data Type:** Text
...
23) **Column\_name: Natural\_Person\_Legal\_Form\_to\_Total**
- **Data Type:** Text
...
24) **column\_name: Rural\_Fixed\_Broadband\_Coverage**
- **Data Type:** Integer
...
25) **column\_name: Rural\_5G\_Cellular\_Network\_Coverage**
- **Data Type:** Integer
...
28) **column\_name: Population\_Density**
- **Data Type:** demical (double)
...
29) **column\_name: Median\_Elevation**
- **Data Type:** demical (double)
...
30) **column\_name: Natural\_Characteristics\_Index**
- **Data Type:** Integer
...
31) **column\_name: Socio-economic\_Similarity\_Index**
- **Data Type:** Integer
...
32) **column\_name: Fertilization\_Need\_Index**
- **Data Type:** demical (double)
...
33) **column\_name: Irrigation\_Need\_Index**
- **Data Type:** demical (double)
...
34) **column\_name: Pest\_Management\_Need\_Index**
- **Data Type:** demical (double)
...
35) **column\_name: Rural\_Connectivity\_Performance\_Index**
- **Data Type**: demical (double)
